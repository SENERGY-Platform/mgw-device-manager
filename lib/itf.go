...
type Api interface {
	GetDevice(ctx context.Context, id string) (model.DeviceBase, error)
	GetDevices(ctx context.Context, filter model.DevicesFilter) (map[string]model.DeviceBase, error)
